...
class GetSchoolsWithRequest : AsyncTask<JSONObject, Void, List<School>?>() {
    ...
    override fun doInBackground(vararg params: JSONObject?): List<School>? {
        ...
        var response: String? = HttpConnectionUtil().requestPost(Constants.URL + Constants.FIND_SCHOOLS_WITH, params[0])
